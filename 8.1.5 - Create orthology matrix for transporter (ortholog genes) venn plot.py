...
folder1 = "Data/Transporter Lists/Ortholog genes"
folder2 = "Data/Gene lists/Transporters/Ortholog genes"

out_folder = "Results/Summary matrices\Transporters (ortholog genes)"

os.makedirs(out_folder,exist_ok=True)

## files ##

file_CT_rat = "Transporter_list_concatenated_rat_ortholog.csv"
file_CT_human = "Transporter_list_concatenated_human_ortholog.csv"
file_CT_zebrafish = "Transporter_list_concatenated_zebrafish_ortholog.csv"
file_CT_mouse = "Transporter_list_concatenated_mouse_ortholog.csv"
...
file_summary_matrix = "Summary matrix table Transporters (ortholog genes).csv"
