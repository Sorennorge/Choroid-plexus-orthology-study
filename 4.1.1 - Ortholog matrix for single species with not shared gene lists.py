...
### Ortholog matrix for single species (not shared) ###
...
folder2 = "Data/Biomart/Ortholog matrices"
folder3 = "Data/Gene lists/All genes"
...
with open(os.path.join(folder2,biomart_rat),'r') as read:
    for count, line in enumerate(read):
        pass
read.close()
Length_matrix_rat = int((count+1)/100)
with open(os.path.join(folder2,biomart_human),'r') as read:
    for count, line in enumerate(read):
        pass
read.close()
Length_matrix_human = int((count+1)/100)
with open(os.path.join(folder2,biomart_zebrafish),'r') as read:
    for count, line in enumerate(read):
        pass
read.close()
Length_matrix_zfish = int((count+1)/100)
with open(os.path.join(folder2,biomart_mouse),'r') as read:
    for count, line in enumerate(read):
        pass
read.close()
...
if check_exist(folder3, file_not_shared_rat) and check_exist(folder3, file_not_shared_human) and check_exist(folder3, file_not_shared_zebrafish) and check_exist(folder3, file_not_shared_mouse):
    with open(os.path.join(folder3,file_not_shared_rat),'r') as read:
        for line in read:
            line = line.strip()
            non_shared_rat.append(line)
    read.close
    with open(os.path.join(folder3,file_not_shared_human),'r') as read:
        for line in read:
            line = line.strip()
            non_shared_human.append(line)
    read.close
    with open(os.path.join(folder3,file_not_shared_zebrafish),'r') as read:
        for line in read:
            line = line.strip()
            non_shared_zebrafish.append(line)
    read.close
    with open(os.path.join(folder3,file_not_shared_mouse),'r') as read:
        for line in read:
            line = line.strip()
...
if error_key == 0:
    ...
    with open(os.path.join(folder1,Complete_orto_matrix_file),'w+') as out:
