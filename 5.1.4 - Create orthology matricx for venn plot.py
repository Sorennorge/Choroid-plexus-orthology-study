...
### Create orthology matrix summaries for venn plots ###
...
folder1 = "Data/Count tables/Ortholog genes"
folder2 = "Data/Gene lists/Ortholog genes"

folder_out = "Results/Summary matrices/Ortholog genes"

os.makedirs(folder_out,exist_ok=True)

## files ##

file_CT_rat = "Rat_count_table_ortholog.csv"
file_CT_human = "Human_count_table_ortholog.csv"
file_CT_zebrafish = "Zebrafish_count_table_ortholog.csv"
file_CT_mouse = "Mouse_count_table_ortholog.csv"
...
file_summary_matrix = "Summary matrix table orthologs.csv"
...
if error_input_key == 0:
    ...
    if sanity_check == 1:
        ...
        with open(os.path.join(folder_out,file_summary_matrix),'w+') as out:
