...
### Orthlog list in CP -> Ortholog matrix -> percentage of ortholog genes ###

## Program parameters ##

print_output = "yes" # "yes" print output, anything else skips this
...
folder2 = "Data/Count tables/Ortholog genes"
folder3 = "Data/Gene lists/Ortholog genes"
...
rat_file = "Rat_count_table_ortholog.csv"
human_file = "Human_count_table_ortholog.csv"
zebrafish_file = "Zebrafish_count_table_ortholog.csv"
mouse_file = "Mouse_count_table_ortholog.csv"
...
if check_exist(folder1,Ortholog_matrix_file):
    ...
    print("Matrix or Count tables are missing.")
